...
public class OrderingDonutsController {
    ...
    {
        if( this.donutFlavors.getSelectionModel().getSelectedItem()==null
            ||
            this.donutTypes.getSelectionModel().getSelectedItem()==null){
            return null;
        }
    ...
    void addToChoice()
    {
        orderFlavors.getSelectionModel().selectFirst();
